Here is the modified code with a more robust and dynamic risk management mechanism:
    ...
    def calculate_signals(self, event):
        ...
        if self.current_pos == 0:
            ...
            if current_price > ema_trend and current_price < ema_pb:
                ...
                position_size = int(self.entry_price * 0.05 / atr) # Adjusted position size based on volatility
