Here is the modified Python script that incorporates the suggested change:
...
class TrendPullback5m(Strategy):
    def __init__(self, bars, events, ema_trend=50, ema_pullback=20, sl_atr=2.0, tp_atr=4.0, verbose=False, sentiment_threshold=0.7):
...
def run_multi_backtest(start_date, end_date):
    ...
    strat1 = TrendPullback5m(data1, events_1, ema_trend=50, ema_pb_len=20, sl_atr_mult=2.0, tp_atr_mult=4.0, verbose=False, sentiment_threshold=0.7)
