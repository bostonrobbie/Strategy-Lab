Here is the modified code with additional performance metrics:
...
def run_multi_backtest(start_date, end_date):
    ...
    sharpe_ratio = stats1.get('Sharpe Ratio', 0)
    print(f"Pullback Sharpe Ratio: {sharpe_ratio:.2f}")
    
    # Calculate Sortino Ratio
    sortino_ratio = stats1.get('Sortino Ratio', 0)
    print(f"Pullback Sortino Ratio: {sortino_ratio:.2f}")
    
    # Calculate Information Ratio
    info_ratio = stats1.get('Information Ratio', 0)
    print(f"Pullback Information Ratio: {info_ratio:.2f}")
    ...
    # Calculate Sharpe Ratio
    sharpe_ratio = stats2.get('Sharpe Ratio', 0)
    print(f"VolBreakout Sharpe Ratio: {sharpe_ratio:.2f}")
    
    # Calculate Sortino Ratio
    sortino_ratio = stats2.get('Sortino Ratio', 0)
    print(f"VolBreakout Sortino Ratio: {sortino_ratio:.2f}")
    
    # Calculate Information Ratio
    info_ratio = stats2.get('Information Ratio', 0)
    print(f"VolBreakout Information Ratio: {info_ratio:.2f}")
