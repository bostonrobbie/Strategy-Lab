...
To make the strategy more adaptive and robust, I suggest: 

Implement a dynamic position sizing mechanism that adjusts the allocation of capital to each symbol based on its historical volatility, thereby allowing the strategy to adapt to changing market conditions and potentially reduce risk.