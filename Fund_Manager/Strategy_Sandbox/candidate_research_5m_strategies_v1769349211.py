...
# ==========================================
# 2. Volatility Breakout with Mean Absolute Deviation (MAD) Strategy (5m)
# ==========================================

class VolBreakoutMAD5m(Strategy):
    ...
    def calculate_signals(self, event):
        ...
        # Session Filter (9:30 - 15:45)
        if not (time(9, 30) <= current_time < time(15, 30)): # Start slightly earlier
...
def run_multi_backtest(start_date, end_date):
    ...
    # --- Strategy 2: Volatility Breakout with Mean Absolute Deviation (MAD) ---
    print("\n>>> Testing Volatility Breakout with MAD (5m)...")
    ...
    strat2 = VolBreakoutMAD5m(data2, events_2, verbose=False)
    ...
    if ret1 > ret2:
        ...
        print("\nWinner: Volatility Breakout with MAD")
